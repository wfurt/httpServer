...
namespace System
{
    internal static partial class SR
    {
        ...
        internal static global::System.Resources.ResourceManager ResourceManager => s_resourceManager ?? (s_resourceManager = new global::System.Resources.ResourceManager(typeof(FxResources.System.Net.Http.SR)));
        ...
        /// <summary>The header name '{0}' has an invalid format.</summary>
        internal static string @net_http_headers_invalid_header_name => GetResourceString("net_http_headers_invalid_header_name", @"The header name '{0}' has an invalid format.");
        ...
        internal static string @net_http_headers_no_newlines => GetResourceString("net_http_headers_no_newlines", @"New-line characters are not allowed in header values.");
        ...
        internal static string @net_http_content_writeonly_stream => GetResourceString("net_http_content_writeonly_stream", @"The stream does not support reading.");
        ...
        internal static string @net_http_content_read_as_stream_has_task => GetResourceString("net_http_content_read_as_stream_has_task", @"The content's stream has already been retrieved via async ReadAsStreamAsync and cannot be subsequently accessed synchronously.");
        ...
        internal static string @net_http_client_invalid_requesturi => GetResourceString("net_http_client_invalid_requesturi", @"An invalid request URI was provided. Either the request URI must be an absolute URI or BaseAddress must be set.");
        /// <summary>The '{0}' scheme is not supported.</summary>
        internal static string @net_http_unsupported_requesturi_scheme => GetResourceString("net_http_unsupported_requesturi_scheme", @"The '{0}' scheme is not supported.");
        ...
        internal static string @net_http_log_headers_no_newlines => GetResourceString("net_http_log_headers_no_newlines", @"Value for header '{0}' contains new-line characters. Value: '{1}'.");
        ...
        internal static string @net_http_value_must_be_greater_than_or_equal => GetResourceString("net_http_value_must_be_greater_than_or_equal", @"The specified value '{0}' must be greater than or equal to '{1}'.");
        ...
        internal static string @net_http_request_content_length_mismatch => GetResourceString("net_http_request_content_length_mismatch", @"Sent {0} request content bytes, but Content-Length promised {1}.");
        ...
        internal static string @net_http_invalid_response_multiple_status_codes => GetResourceString("net_http_invalid_response_multiple_status_codes", @"The response contained more than one status code.");
        ...
        internal static string @net_http_invalid_proxy_scheme => GetResourceString("net_http_invalid_proxy_scheme", @"Only the 'http', 'socks4', 'socks4a' and 'socks5' schemes are allowed for proxies.");
        ...
        /// <summary>The HTTP/2 server closed the connection. HTTP/2 error code '{0}' (0x{1}).</summary>
        internal static string @net_http_http2_connection_close => GetResourceString("net_http_http2_connection_close", @"The HTTP/2 server closed the connection. HTTP/2 error code '{0}' (0x{1}).");
        ...
        /// <summary>The HTTP/3 server reset the stream. HTTP/3 error code '{0}' (0x{1}).</summary>
        internal static string @net_http_http3_stream_error => GetResourceString("net_http_http3_stream_error", @"The HTTP/3 server reset the stream. HTTP/3 error code '{0}' (0x{1}).");
        /// <summary>An HTTP/2 connection could not be established because the server did not complete the HTTP/2 handshake.</summary>
        internal static string @net_http_http2_connection_not_established => GetResourceString("net_http_http2_connection_not_established", @"An HTTP/2 connection could not be established because the server did not complete the HTTP/2 handshake.");
        /// <summary>The initial HTTP/2 stream window size must be between {0} and {1}.</summary>
        internal static string @net_http_http2_invalidinitialstreamwindowsize => GetResourceString("net_http_http2_invalidinitialstreamwindowsize", @"The initial HTTP/2 stream window size must be between {0} and {1}.");
        ...
        /// <summary>Authentication validation failed with error - {0}.</summary>
        internal static string @net_http_authvalidationfailure => GetResourceString("net_http_authvalidationfailure", @"Authentication validation failed with error - {0}.");
        ...
        /// <summary>The HTTP/3 server closed the connection. HTTP/3 error code '{0}' (0x{1}).</summary>
        internal static string @net_http_http3_connection_close => GetResourceString("net_http_http3_connection_close", @"The HTTP/3 server closed the connection. HTTP/3 error code '{0}' (0x{1}).");
        ...
        internal static string @net_http_connect_timedout => GetResourceString("net_http_connect_timedout", @"A connection could not be established within the configured ConnectTimeout.");
        ...
        internal static string @net_http_missing_sync_implementation => GetResourceString("net_http_missing_sync_implementation", @"The synchronous method is not supported by '{0}'. If you're using a custom '{1}' and wish to use synchronous HTTP methods, you must override its '{2}' virtual method.");
        ...
        internal static string @net_http_http2_sync_not_supported => GetResourceString("net_http_http2_sync_not_supported", @"The synchronous method is not supported by '{0}' for HTTP/2 or higher. Either use an asynchronous method or downgrade the request version to HTTP/1.1 or lower.");
        ...
        internal static string @net_http_upgrade_not_enabled_sync => GetResourceString("net_http_upgrade_not_enabled_sync", @"HTTP request version upgrade is not enabled for synchronous '{0}'. Do not use '{1}' version policy for synchronous HTTP methods.");
        /// <summary>Requesting HTTP version {0} with version policy {1} while unable to establish HTTP/{2} connection.</summary>
        internal static string @net_http_requested_version_cannot_establish => GetResourceString("net_http_requested_version_cannot_establish", @"Requesting HTTP version {0} with version policy {1} while unable to establish HTTP/{2} connection.");
        /// <summary>Requesting HTTP version {0} with version policy {1} while server offers only version fallback.</summary>
        internal static string @net_http_requested_version_server_refused => GetResourceString("net_http_requested_version_server_refused", @"Requesting HTTP version {0} with version policy {1} while server offers only version fallback.");
        /// <summary>An exception occurred while invoking the PlaintextStreamFilter.</summary>
        internal static string @net_http_exception_during_plaintext_filter => GetResourceString("net_http_exception_during_plaintext_filter", @"An exception occurred while invoking the PlaintextStreamFilter.");
        /// <summary>The user-supplied ConnectCallback returned null.</summary>
        internal static string @net_http_null_from_connect_callback => GetResourceString("net_http_null_from_connect_callback", @"The user-supplied ConnectCallback returned null.");
        /// <summary>The user-supplied PlaintextStreamFilter returned null.</summary>
        internal static string @net_http_null_from_plaintext_filter => GetResourceString("net_http_null_from_plaintext_filter", @"The user-supplied PlaintextStreamFilter returned null.");
        /// <summary>Internal error marshalling the response Promise from `fetch`.</summary>
        internal static string @net_http_marshalling_response_promise_from_fetch => GetResourceString("net_http_marshalling_response_promise_from_fetch", @"Internal error marshalling the response Promise from `fetch`.");
        /// <summary>Synchronous reads are not supported, use ReadAsync instead.</summary>
        internal static string @net_http_synchronous_reads_not_supported => GetResourceString("net_http_synchronous_reads_not_supported", @"Synchronous reads are not supported, use ReadAsync instead.");
        /// <summary>Failed to authenticate with the SOCKS server.</summary>
        internal static string @net_socks_auth_failed => GetResourceString("net_socks_auth_failed", @"Failed to authenticate with the SOCKS server.");
        /// <summary>SOCKS server returned an unknown address type.</summary>
        internal static string @net_socks_bad_address_type => GetResourceString("net_socks_bad_address_type", @"SOCKS server returned an unknown address type.");
        /// <summary>SOCKS server failed to connect to the destination.</summary>
        internal static string @net_socks_connection_failed => GetResourceString("net_socks_connection_failed", @"SOCKS server failed to connect to the destination.");
        /// <summary>SOCKS4 does not support IPv6 addresses.</summary>
        internal static string @net_socks_ipv6_notsupported => GetResourceString("net_socks_ipv6_notsupported", @"SOCKS4 does not support IPv6 addresses.");
        /// <summary>SOCKS server did not return a suitable authentication method.</summary>
        internal static string @net_socks_no_auth_method => GetResourceString("net_socks_no_auth_method", @"SOCKS server did not return a suitable authentication method.");
        /// <summary>Failed to resolve the destination host to an IPv4 address.</summary>
        internal static string @net_socks_no_ipv4_address => GetResourceString("net_socks_no_ipv4_address", @"Failed to resolve the destination host to an IPv4 address.");
        /// <summary>Unexpected SOCKS protocol version. Required {0}, got {1}.</summary>
        internal static string @net_socks_unexpected_version => GetResourceString("net_socks_unexpected_version", @"Unexpected SOCKS protocol version. Required {0}, got {1}.");
        /// <summary>Encoding the {0} took more than the maximum of 255 bytes.</summary>
        internal static string @net_socks_string_too_long => GetResourceString("net_socks_string_too_long", @"Encoding the {0} took more than the maximum of 255 bytes.");
        /// <summary>SOCKS server requested username &amp; password authentication.</summary>
        internal static string @net_socks_auth_required => GetResourceString("net_socks_auth_required", @"SOCKS server requested username & password authentication.");
        /// <summary>The proxy tunnel request to proxy '{0}' failed with status code '{1}'."</summary>
        internal static string @net_http_proxy_tunnel_returned_failure_status_code => GetResourceString("net_http_proxy_tunnel_returned_failure_status_code", @"The proxy tunnel request to proxy '{0}' failed with status code '{1}'.""");
        /// <summary>System.Net.Http is not supported on this platform.</summary>
        internal static string @PlatformNotSupported_NetHttp => GetResourceString("PlatformNotSupported_NetHttp", @"System.Net.Http is not supported on this platform.");
        /// <summary>The HTTP/1.1 response chunk was too large.</summary>
        internal static string @net_http_chunk_too_large => GetResourceString("net_http_chunk_too_large", @"The HTTP/1.1 response chunk was too large.");
        /// <summary>Failed to establish web socket connection over HTTP/2 because extended CONNECT is not supported. Try to downgrade the request version to HTTP/1.1.</summary>
        internal static string @net_unsupported_extended_connect => GetResourceString("net_unsupported_extended_connect", @"Failed to establish web socket connection over HTTP/2 because extended CONNECT is not supported. Try to downgrade the request version to HTTP/1.1.");
