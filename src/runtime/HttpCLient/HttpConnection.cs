...
{
    internal partial class HttpConnection : HttpConnectionBase
    {
...
#pragma warning restore CA2012
        ...
        private async ValueTask WriteHeadersAsync(HttpHeaders headers, string? cookiesFromContainer, bool async)
        {
            ...
            throw new PlatformNotSupportedException("WriteHeadersAsync");
#if ME
        ...
        {
            throw new PlatformNotSupportedException("SendAsyncCore");
#if ME
        ...
        private void ProcessKeepAliveHeader(string keepAlive)
        {
            ...
            if (NameValueHeaderValueExtensions.GetNameValueListLength(keepAlive, 0, ',', parsedValues) == keepAlive.Length)
            {
