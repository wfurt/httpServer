...
namespace System.Net.Http.Headers
{
    ...
    public class NameValueHeaderValueClone : NameValueHeaderValue
    {
...
*/
        //internal NameValueHeaderValueClone()
        //{
        //}

        public NameValueHeaderValueClone(string name)
            : this(name, null)
        {
        }

        /*
        public NameValueHeaderValueClone(string name, string? value)
        {
        ...
        */
        ...
        /*
        protected internal NameValueHeaderValueClone(NameValueHeaderValue source)
        {
        ...
        */
        ...
        public override bool Equals([NotNullWhen(true)] object? obj)
        {
            ...
            if (!string.Equals(_name, other.Name, StringComparison.OrdinalIgnoreCase))
            {
                return false;
            }
